...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            if (isset($_SESSION['username'])): ?>
                <li><a href="users.php"><?php echo htmlspecialchars($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a>님</li>
                <li>|</li>
    ...
    <div class="container">
        ...
        <form class="form_css" method="POST" action="">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'], ENT_QUOTES, 'UTF-8'); ?>"> <!--추가-->
